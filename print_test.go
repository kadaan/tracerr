...
func TestPrint(t *testing.T) {
	...
	cases := []PrintTestCase{
		...
		},
		{
			...
			ExpectedRows: []string{
				message,
				"/src/github.com/kadaan/tracerr/error_helper_test.go:17 github.com/kadaan/tracerr_test.addFrameC()",
				"/src/github.com/kadaan/tracerr/error_helper_test.go:13 github.com/kadaan/tracerr_test.addFrameB()",
				"/src/github.com/kadaan/tracerr/error_helper_test.go:9 github.com/kadaan/tracerr_test.addFrameA()",
				"/src/github.com/kadaan/tracerr/print_test.go:26 github.com/kadaan/tracerr_test.TestPrint()",
			},
		...
		},
		{
			...
			ExpectedRows: []string{
				message,
				"",
				aurora.Bold("/src/github.com/kadaan/tracerr/error_helper_test.go:17 github.com/kadaan/tracerr_test.addFrameC()").String(),
				...
				"",
				aurora.Bold("/src/github.com/kadaan/tracerr/error_helper_test.go:13 github.com/kadaan/tracerr_test.addFrameB()").String(),
				...
				"",
				aurora.Bold("/src/github.com/kadaan/tracerr/error_helper_test.go:9 github.com/kadaan/tracerr_test.addFrameA()").String(),
				...
				"",
				aurora.Bold("/src/github.com/kadaan/tracerr/print_test.go:26 github.com/kadaan/tracerr_test.TestPrint()").String(),
...
func assertRows(t *testing.T, i int, output string, expectedRows []string, extra int) {
	...
	re := regexp.MustCompile("([^/]*)/.*(/src/github\\.com/kadaan/tracerr/.*)")
